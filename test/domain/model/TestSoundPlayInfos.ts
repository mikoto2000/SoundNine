...
describe('SoundPlayInfos.ts', () => {
    it('インスタンス化', () => {
        ...
        const soundPlayInfos = new SoundPlayInfos([
            new SoundPlayInfo(Sound.createFromString("sound1", "file:///path/to/sound1"), 1),
            new SoundPlayInfo(Sound.createFromString("sound2", "file:///path/to/sound2"), 2),
            new SoundPlayInfo(Sound.createFromString("sound3", "file:///path/to/sound3"), 3)
        ]);

        assert.equal(soundPlayInfos.length, 3);

        assert.equal(soundPlayInfos.getSoundPlayInfo(0).soundName, "sound1");
        assert.equal(soundPlayInfos.getSoundPlayInfo(0).soundUrl.toString(), "file:///path/to/sound1");
        ...
        assert.equal(soundPlayInfos.getSoundPlayInfo(1).soundUrl.toString(), "file:///path/to/sound2");
        ...
        assert.equal(soundPlayInfos.getSoundPlayInfo(2).soundUrl.toString(), "file:///path/to/sound3");
